...
# Initialize points and click counter
points = 0
click_counter = 0
...
def setup():
    ...
    background(400);
    global rat
    rat = loadImage("RatCzar.png")  # Load the rat image
    global hammer
...
def update_points():
    ...
    points += 100  # Increment points when the rat is clicked
    if points >= 1000:
...
def mouseClicked():
    ...
    if current_state == START_SCREEN:
        ...
        # Check if the mouse is clicked on the rat image
